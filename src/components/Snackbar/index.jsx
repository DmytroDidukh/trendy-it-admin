...
const Snackbar = () => {
  ...
  const { snackbarVisibility, snackbarSeverity, snackbarMessage } = useSelector(
    ({ Snackbar }) => ({
  ...
  }, [dispatch, snackbarVisibility, snackbarMessage]);

  return (
    <div
      className={classNames('snackbar', {
        active: snackbarVisibility,
        success: snackbarSeverity,
        error: !snackbarSeverity
      })}
    >
