...
import {deleteOrder, setOrder, updateOrderStatus, getOrderById} from "../../redux/order/order.actions";
...
const OrderRedactor = ({id}) => {
    ...
    const {customer, delivery, status, createdAt, connectionMethod, products, deliveryPrice, paymentMethod} = order ? order : {}
    ...
    const totalProductSum = useMemo(() => products && orderSumCounter(products), [products])
